...
function main() {
    ...
    // otherwise call printSemester() for all courses for each semester
        ...
        echo "<h3>Spring 2020</h3>";
        printSemester("20/SP");
        echo "<h3>Summer 2020</h3>";
        printSemester("20/SU");
...
function printListing($apiCall) {
    ...
    if (!($obj->courses == null)) {
        ...
        foreach ($obj->courses as $course) {
			...
			if(strcmp(substr($course->meetingTimes[0]->days,0,1),'M')){
					continue;
			}
			//else if(strcmp(substr($course->meetingTimes[0]->days,0,1),'')) continue;
			//else continue;
